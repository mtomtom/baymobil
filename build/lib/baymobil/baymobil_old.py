...
def fasterpostN2new(Nhomo1, nhomo1, Nhomo2, nhomo2, N, n, nmax):
    ...
    ## THIS IS WHERE WE CAP THE DATA: any values greater than 10 are set to 10, less than -2 are set to -2.
    ## Comment out the two lines below if you don't want to include this
    if logBF21N2 > 10: logBF21N2 = 10
    if logBF21N2 < -2: logBF21N2 = -2
